...
var margin = { top: 0, right: 120, bottom: 0, left: 180 },
...
function doStuff(selector, data) {
...
Reveal.addEventListener('gisTree', function () {
    doStuff("#gisTree", gisData[0]);
}, false);


//Reveal.addEventListener('appsTree', function () {
//    doStuff("#appsTree", appsData[0]);
//}, false);
